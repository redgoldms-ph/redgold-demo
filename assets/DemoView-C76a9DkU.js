import{R as S,b as M,c as F,_ as E,d as Z,a as k,e as Y}from"./LangMenu-D_jM_5gS.js";import{B as T,y as B,z as Q,w as j,o as d,c as g,a as l,k as A,x as N,m,n as C,t as h,C as L,D as O,j as W,F as w,v as U,p as z,E as H,q as b,_ as f,d as c,b as I,u as J}from"./index-DvadGdwh.js";var K=function(n){var t=n.dt;return`
.p-togglebutton {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
...
`)},$={root:function(n){var t=n.instance,u=n.props;return["p-togglebutton p-component",{"p-togglebutton-checked":t.active,"p-invalid":u.invalid}]},content:"p-togglebutton-content",icon:"p-togglebutton-icon",label:"p-togglebutton-label"},q=T.extend({name:"togglebutton",theme:K,classes:$}),ee={name:"BaseToggleButton",extends:M,props:{modelValue:Boolean,onIcon:String,offIcon:String,onLabel:{type:String,default:"Yes"},offLabel:{type:String,default:"No"},iconPos:{type:String,default:"left"},invalid:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},readonly:{type:Boolean,default:!1},tabindex:{type:Number,default:null},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:q,provide:function(){return{$pcToggleButton:this,$parentInstance:this}}},G={name:"ToggleButton",extends:ee,inheritAttrs:!1,emits:["update:modelValue","change"],methods:{getPTOptions:function(n){var t=n==="root"?this.ptmi:this.ptm;return t(n,{context:{active:this.active,disabled:this.disabled}})},onChange:function(n){!this.disabled&&!this.readonly&&(this.$emit("update:modelValue",!this.modelValue),this.$emit("change",n))}},computed:{active:function(){return this.modelValue===!0},hasLabel:function(){return B(this.onLabel)&&B(this.offLabel)},label:function(){return this.hasLabel?this.modelValue?this.onLabel:this.offLabel:"&nbsp;"}},directives:{ripple:S}},te=["tabindex","disabled","aria-pressed","data-p-checked","data-p-disabled"];function ne(e,n,t,u,a,o){var r=Q("ripple");return j((d(),g("button",m({type:"button",class:e.cx("root"),tabindex:e.tabindex,disabled:e.disabled,"aria-pressed":e.modelValue,onClick:n[0]||(n[0]=function(){return o.onChange&&o.onChange.apply(o,arguments)})},o.getPTOptions("root"),{"data-p-checked":o.active,"data-p-disabled":e.disabled}),[l("span",m({class:e.cx("content")},o.getPTOptions("content")),[A(e.$slots,"default",{},function(){return[A(e.$slots,"icon",{value:e.modelValue,class:N(e.cx("icon"))},function(){return[e.onIcon||e.offIcon?(d(),g("span",m({key:0,class:[e.cx("icon"),e.modelValue?e.onIcon:e.offIcon]},o.getPTOptions("icon")),null,16)):C("",!0)]}),l("span",m({class:e.cx("label")},o.getPTOptions("label")),h(o.label),17)]})],16)],16,te)),[[r]])}G.render=ne;var oe=function(n){var t=n.dt;return`
.p-selectbutton {
    display: inline-flex;
    user-select: none;
